...
대신 아래와 같이 (n*4) 형식으로 선언하였습니다(저는 tfrecord에서 (n, 4) 형식으로 선언이 안되더군요... ㅠㅠ)
...
![image-20211112203250204](https://github.com/myunghakLee/myunghakLee.github.io/blob/master/blog_images/image-20211112203250204.png?raw=tru)